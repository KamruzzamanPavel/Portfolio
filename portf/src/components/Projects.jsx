...
const Projects = () => {
  ...
  return (
    <section className="my-4 bg-white dark:bg-black rounded text-black dark:text-white pt-5">
      {/* <h2 className="text-3xl font-bold mb-4 text-center">Projects</h2> */}
      <div className="flex flex-col md:flex-row justify-center items-center py-2">
        <span className="text-sm md:text-3xl font-bold m-1 md:mb-4 text-center text-slate-400  ">
          Explore My Recent
        </span>
        <span className="text-xl md:text-3xl font-bold  mb-2 md:mb-4 text-center  ">
          Projects
        </span>{" "}
      </div>
      <Swiper
