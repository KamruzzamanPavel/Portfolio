...
//     <section
//       id="skill"
//       className="my-12 bg-white dark:bg-black text-black dark:text-white py-8"
//     >
...
//         {/* Front-End Skills */}
//         <div className="max-w-xs sm:max-w-sm md:max-w-md bg-gray-100 dark:bg-gray-800 p-4 rounded-lg shadow-md">
//           <h3 className="text-2xl font-semibold mb-4 text-center">Front-End</h3>
//           <ul className="list-none text-gray-800 dark:text-gray-300">
...
const Skills = () => {
  return (
    ...
    >
      <h2 className="text-3xl md:text-4xl font-bold text-center mb-8">
        <span className="text-blue-600 dark:text-blue-500">Skills</span> , Those
        I Gained on the way
      </h2>
